...
if ($conn) {
$query = "INSERT INTO seminarorg1(type, category, welcome, title, date, venue, abstract, sender, email, others, filename, filelocation, modifiedtimestamp, status) VALUES ('$type', '$e_type', '$welcome', '$e_nameinsert', '$date', '$venue', '$e_desinsert', '$sender', '$email', '$other', '$nam', '$fullpath', '$timestamp', '$status')";
