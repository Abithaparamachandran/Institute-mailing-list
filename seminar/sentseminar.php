...
$query = "SELECT * FROM seminarorg WHERE modifiedtimestamp BETWEEN '$startDate' AND '$endDate' AND flag='0' AND type='seminar'";
echo "Query: $query<br>";
...
$updateQuery = "UPDATE seminarorg SET flag='1' WHERE id='" . $row['id'] . "'";
mysqli_query($conn, $updateQuery);
}
$mail->From = 'Eservices'; 
$mail->FromName = 'Seminars';
$mail->addAddress("seminars@list.iitm.ac.in");
$mail->isHTML(true);
