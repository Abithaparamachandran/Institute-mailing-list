...
/*$queryFindDuplicate = "select flag from seminarorg where id = '$lastID'";
$resultFindDuplicate=mysqli_query($conn,$queryFindDuplicate);

while ($row = mysqli_fetch_array($resultFindDuplicate)) 
{ 
$flagValue = $row['flag'];
}
*/
