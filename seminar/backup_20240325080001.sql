...
INSERT INTO `seminarorg` VALUES (1,'seminar','Guest Lectures','NULL','test','test','test','test','test','2024/03/22 19:45','2024-03-22','','test','','test','test','test-web confernce link','','',1,'2024-03-22 09:12:09','Active'),(2,'','News Letter',NULL,'test',NULL,NULL,NULL,NULL,NULL,NULL,'Yes',NULL,'test','test','test','test',NULL,NULL,0,'2024-03-22 09:15:06','default_value'),(3,'','Others','test','test',NULL,NULL,NULL,NULL,'2024/03/22 20:30',NULL,NULL,'test','','tets','tets','','','',1,'2024-03-22 09:16:41','Active');
...
-- Dump completed on 2024-03-25  8:00:01
